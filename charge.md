<ui style="position:fixed;left: 3em; top:10em; font-size: 0.8em;">
    ...
    <li><a href = "#charge_types"><bold>4. 전기차 차종별 충전방식</bold></a></li>
    <li><a href = "#charge_owner"><bold>5. 충전기 소유자에 따른 분류</bold></a></li>
</ui>
...
- 완전방전에서 완전충전까지 4~5시간이 소요
- 주로 주택이나 아파트에 설치
- 배터리 용량은 약 6~7kW 전력용량을 가진 충전기가 주로 설치
- 전기요금은 100km당, 1,100원 정도
- 제조사별로 충전 커넥터 방식이 달라 호환이 좋지 않음
...
| ---------------- | ---------------------------- | ------------------------------- |
| 사용 전류        | 교류(AC)                     | 직류(DC)                        |
| 충전 시간        | 4~5시간<br/> (0 ~ 100% 충전) | 15 ~ 30분 <br>(0 ~ 80% 충전)    |
| 전력 용량        | 전력 용량 : 6~7kW<br/>       | 50kW                            |
| 충전 요금        | 약 100km당 1,100원<br/>      | 약 100km당 2,700원              |
| 충전기 설치 장소 | 가정(주택 및 아파트)         | 공공 장소(휴게소, 공공 기관 등) |
...
| 현대기아차 |  아이오닉, 코나, 니로, 쏘울  | DC콤보 7핀(급속) | AC 단상(5pin) |
|  르노삼성  |            SM3 ZE            |   AC3상(7pin)    | AC 단상(7pin) |
